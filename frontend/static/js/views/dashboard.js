        ...
        async getHtml() {
            ...
            <section id="games">
                <div class="container-fluid py-5 pt-3 row d-flex mx-auto justify-content-center">
                    <ul style="list-style-type: none;">
                        <li class="pr-5">
                            <a href="/R6"><img src="./static/Images/Images/R6.png" width="40%" class="zoom" data-link></a>
                        </li>
                        <li>
                            <a href="/CSGO"><img src="./static/Images/Images/CS.png" width="40%" class="zoom" data-link></a>
                        </li>
                    </ul>
                  </div>
                </section>   
